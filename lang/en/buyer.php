...
return [
    ...
    'request_detail' => [
        ...
        'quote_locked_help_free' => 'This free (無償) option is confirmed -- it can no longer be changed.',
        ...
        'checkout_button_free' => 'Confirm free order',

        'paid_banner_heading' => 'Payment confirmed',
        'paid_banner_body' => 'Your order is being processed -- we\'ll notify you when it ships.',
        'paid_banner_heading_free' => 'Free order confirmed',
        'paid_banner_body_free' => 'No payment was required for this order -- it\'s being processed and we\'ll notify you when it ships.',

        'payment_summary_section' => 'Payment summary',
        'payment_summary_section_free' => 'Order summary',
        ...
        'payment_summary_total_free' => 'Total',
    ...
    'checkout' => [
        ...
        'free_confirmed' => 'Your free (無償) order for :code is confirmed -- no payment was required. It\'s being processed and we\'ll notify you when it ships.',

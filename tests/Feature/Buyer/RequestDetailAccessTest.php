...
it('redirects a guest to login', function () {
    ...
    $this->get("/buyer/requests/{$request->id}")->assertRedirect('/login');
});
...
it('forbids an admin', function () {
    ...
    $this->actingAs($admin)->get("/buyer/requests/{$request->id}")->assertForbidden();
});
...
it('forbids a vendor', function () {
    ...
    $this->actingAs($vendor)->get("/buyer/requests/{$request->id}")->assertForbidden();
});

it('forbids a buyer viewing another buyer\'s request', function () {
    ...
    $this->actingAs($otherBuyer)->get("/buyer/requests/{$request->id}")->assertForbidden();
});
